...
# Firework Trail
execute at @s[scores={rlfx_rand=2}] run particle minecraft:firework ~ ~.85 ~ .25 .25 .25 .01 2 force
# Area of Effect Welcome Hearts
execute at @s[scores={rlfx_rand=3}] run particle minecraft:heart ~ ~15 ~ 15 6 15 .01 80 force
# Ethereal Effect
execute at @s[scores={rlfx_rand=4}] run particle minecraft:portal ~ ~.55 ~ .25 .25 .25 .01 8 force
# Thick Firework Trail
execute at @s[scores={rlfx_rand=5}] run particle minecraft:firework ~ ~15 ~ 15 6 15 .01 80 force
# God Aura Effect
execute at @s[scores={rlfx_rand=6}] run particle minecraft:dragon_breath ~ ~.75 ~ .25 .5 .25 .01 2 force
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# Player "Smoke" Trail
execute at @s[scores={rlfx_rand=10}] run particle minecraft:cloud ~ ~1 ~ 2 2 2 .01 8 force
# Rain Cloud # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
execute at @s[scores={rlfx_rand=11}] run particle minecraft:campfire_cosy_smoke ~ ~4 ~ 1 0.3 1 .001 4 force
execute at @s[scores={rlfx_rand=11}] run particle minecraft:falling_water ~ ~2.45 ~ .7 1 .7 .01 4 force
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
